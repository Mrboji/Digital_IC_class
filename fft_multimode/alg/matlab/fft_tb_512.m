...
%%
%fft与ifft结果比较
f1=fopen('F:\A_my_project\FPGA\Digital_IC_class\fft_multimode\alg\data\y_re_fft512.txt','r');
[y_re_fft,num1]=fscanf(f1,'%04x',[1 inf]);
f2=fopen('F:\A_my_project\FPGA\Digital_IC_class\fft_multimode\alg\data\y_im_fft512.txt','r');
...
f1=fopen('F:\A_my_project\FPGA\Digital_IC_class\fft_multimode\alg\data\y_re_ifft512.txt','r');
[y_re_ifft,num1]=fscanf(f1,'%04x',[1 inf]);
f2=fopen('F:\A_my_project\FPGA\Digital_IC_class\fft_multimode\alg\data\y_im_ifft512.txt','r');
