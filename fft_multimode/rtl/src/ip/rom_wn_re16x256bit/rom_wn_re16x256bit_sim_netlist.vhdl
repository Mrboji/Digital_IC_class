...
--               F:/A_my_project/FPGA/Digital_IC_class/fft_multimode/rtl/syn/syn_vivado/fft_multimode.srcs/sources_1/ip/rom_wn_re16x256bit/rom_wn_re16x256bit_sim_netlist.vhdl
...
entity rom_wn_re16x256bit_spram is
  port (
  ...
  attribute ORIG_REF_NAME of rom_wn_re16x256bit_spram : entity is "spram";
end rom_wn_re16x256bit_spram;

architecture STRUCTURE of rom_wn_re16x256bit_spram is
...
ram_reg_0_255_0_0: unisim.vcomponents.RAM256X1S
    generic map(
      INIT => X"B0F4BDB7D40DACC6B227A2686311B824B7C4EE73D374376539949FA82485A1E4"
    )
        port map (
...
ram_reg_0_255_10_10: unisim.vcomponents.RAM256X1S
    generic map(
      INIT => X"0000000FFF803FC03F01F81F03E0F83E07C1F07E0FC0FE07F807FC001FFFFFFE"
    )
        port map (
      A(7 downto 0) => a(7 downto 0),
      D => d(10),
...
ram_reg_0_255_11_11: unisim.vcomponents.RAM256X1S
    generic map(
      INIT => X"00000000007FFFC000FFF800FFE007FE003FF001FFC001FFF80003FFFFFFFFFE"
    )
        port map (
      A(7 downto 0) => a(7 downto 0),
      D => d(11),
...
ram_reg_0_255_12_12: unisim.vcomponents.RAM256X1S
    generic map(
      INIT => X"000000000000003FFFFFF800001FFFFE00000FFFFFC0000007FFFFFFFFFFFFFE"
    )
        port map (
      A(7 downto 0) => a(7 downto 0),
      D => d(12),
...
ram_reg_0_255_13_13: unisim.vcomponents.RAM256X1S
    generic map(
      INIT => X"0000000000000000000007FFFFFFFFFE00000000003FFFFFFFFFFFFFFFFFFFFE"
    )
        port map (
      A(7 downto 0) => a(7 downto 0),
      D => d(13),
...
ram_reg_0_255_14_14: unisim.vcomponents.RAM256X1S
    generic map(
      INIT => X"FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFE00000000000000000000000000000001"
    )
        port map (
      A(7 downto 0) => a(7 downto 0),
      D => d(14),
...
ram_reg_0_255_15_15: unisim.vcomponents.RAM256X1S
    generic map(
      INIT => X"FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFE00000000000000000000000000000000"
    )
        port map (
      A(7 downto 0) => a(7 downto 0),
      D => d(15),
...
ram_reg_0_255_1_1: unisim.vcomponents.RAM256X1S
    generic map(
      INIT => X"39C1F06B019A05A14FAA4A916B5F5FE2700A0A52ED5B541AF4BF4CFE53E0F8C6"
    )
        port map (
      A(7 downto 0) => a(7 downto 0),
      D => d(1),
...
ram_reg_0_255_2_2: unisim.vcomponents.RAM256X1S
    generic map(
      INIT => X"4F224891DDA441BDD1242DA0CCCA601E0FF35999F497B6E884FBB488EDDB761A"
    )
        port map (
      A(7 downto 0) => a(7 downto 0),
      D => d(2),
...
ram_reg_0_255_3_3: unisim.vcomponents.RAM256X1S
    generic map(
      INIT => X"2F417AF5C997D669CA22B06A8FC6D554AAA9381D53E57758D3282CD8A142FA16"
    )
        port map (
      A(7 downto 0) => a(7 downto 0),
      D => d(3),
...
ram_reg_0_255_4_4: unisim.vcomponents.RAM256X1S
    generic map(
      INIT => X"1A7F2CF36E72981B6C21954CF03E3332666707E19AACF7924FCD63126196034E"
    )
        port map (
      A(7 downto 0) => a(7 downto 0),
      D => d(4),
...
ram_reg_0_255_5_5: unisim.vcomponents.RAM256X1S
    generic map(
      INIT => X"06D5B0F0DAA4E00725752670FFFE0F0E1E1F0001E336A2B63FF1B549E1E4A93E"
    )
        port map (
      A(7 downto 0) => a(7 downto 0),
      D => d(5),
...
ram_reg_0_255_6_6: unisim.vcomponents.RAM256X1S
    generic map(
      INIT => X"01CC95A56CC70000E3136D2A5554AA54AB55AAAB56926E71FFFE3992B4AD98FE"
    )
        port map (
      A(7 downto 0) => a(7 downto 0),
      D => d(6),
...
ram_reg_0_255_7_7: unisim.vcomponents.RAM256X1S
    generic map(
      INIT => X"003C739325AD55554A5A49B366673398CC66333264DB4B5AAAAA94B66C6387FE"
    )
        port map (
      A(7 downto 0) => a(7 downto 0),
      D => d(7),
...
ram_reg_0_255_8_8: unisim.vcomponents.RAM256X1S
    generic map(
      INIT => X"0003F070E39CCCCCD936DB692D2D694A5AD29696D24926C999998C71E3E07FFE"
    )
        port map (
      A(7 downto 0) => a(7 downto 0),
      D => d(8),
...
ram_reg_0_255_9_9: unisim.vcomponents.RAM256X1S
    generic map(
      INIT => X"00000FF01F83C3C3C70E38E71CE318C639CE718E31C71E3878787C0FE01FFFFE"
    )
        port map (
      A(7 downto 0) => a(7 downto 0),
      D => d(9),
...
begin
\gen_sp_ram.spram_inst\: entity work.rom_wn_re16x256bit_spram
     port map (
      a(7 downto 0) => a(7 downto 0),
      clk => clk,
...
entity rom_wn_re16x256bit_dist_mem_gen_v8_0_12 is
  ...
  attribute C_FAMILY of rom_wn_re16x256bit_dist_mem_gen_v8_0_12 : entity is "zynq";
  attribute C_HAS_CLK : integer;
  attribute C_HAS_CLK of rom_wn_re16x256bit_dist_mem_gen_v8_0_12 : entity is 1;
  attribute C_HAS_D : integer;
  attribute C_HAS_D of rom_wn_re16x256bit_dist_mem_gen_v8_0_12 : entity is 1;
  ...
  attribute C_HAS_WE of rom_wn_re16x256bit_dist_mem_gen_v8_0_12 : entity is 1;
  attribute C_MEM_INIT_FILE : string;
  attribute C_MEM_INIT_FILE of rom_wn_re16x256bit_dist_mem_gen_v8_0_12 : entity is "rom_wn_re16x256bit.mif";
  attribute C_MEM_TYPE : integer;
  attribute C_MEM_TYPE of rom_wn_re16x256bit_dist_mem_gen_v8_0_12 : entity is 1;
